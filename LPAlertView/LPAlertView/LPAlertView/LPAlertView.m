...
{
    LPAlertView *alertView = [LPAlertView alertViewWithTitle:title message:message leftTitle:leftTitle rightTitle:rightTitle leftBlock:leftBlock rightBlock:rightBlock forkButton:NO];
    [alertView show];
}

+ (void)showForkWithTitle:(NSString *)title message:(NSString *)message leftTitle:(NSString *)leftTitle rightTitle:(NSString *)rightTitle leftBlock:(void (^)())leftBlock rightBlock:(void (^)())rightBlock
{
    LPAlertView *alertView = [LPAlertView alertViewWithTitle:title message:message leftTitle:leftTitle rightTitle:rightTitle leftBlock:leftBlock rightBlock:rightBlock forkButton:YES];
    [alertView show];
}

#pragma mark - 便利初始化
+ (LPAlertView *)alertViewWithTitle:(NSString *)title message:(NSString *)message leftTitle:(NSString *)leftTitle rightTitle:(NSString *)rightTitle leftBlock:(void (^)())leftBlock rightBlock:(void (^)())rightBlock forkButton:(BOOL)hasfork
{
    //无按钮则不弹出
    ...
    layer.cornerRadius = alertView.baseView.layer.cornerRadius+1;
    ...
    if (hasfork) {
        ...
        DrawFork(alertView.cancelButton);
    }else{
